...
## 6. Development
`archetype-party` is dedicated to enabling best practices. It is therefore crucial that the generator itself follows strong engineering standards to assure quality and performance.

### 6.1. Code standards

ESLint evaluates Javascript code standards before each test run with the `npm-script pretest`.
Heres' a [table of `archetype-party's` ESLint rules][eslint-rules-table-url] and their enforcement.
...
| [<img src="https://avatars3.githubusercontent.com/u/6599333?v=4" width="100px;"/><br /><sub>rm-cortez</sub>](https://github.com/rm-cortez)<br />[👀](#review-rm-cortez "Reviewed Pull Requests") [📖](https://github.com/@gregswindle/archetype-party/commits?author=rm-cortez "Documentation") | [<img src="https://avatars2.githubusercontent.com/u/1043478?v=4" width="100px;"/><br /><sub>Spencer Hamm</sub>](http://spencerhamm.com)<br />[👀](#review-spentacular "Reviewed Pull Requests") |
| :---: | :---: |
...
[issues-new-url]: https://github.com/gregswindle/archetype-party/issues/new
[issues-url]: https://github.com/gregswindle/archetype-party/issues
...
[pr-url]: https://github.com/gregswindle/archetype-party/pulls
